...
const EditRoutineModal = ({ routine, onClose }: EditRoutineModalProps) => {
  ...
  const [selectedIcon, setSelectedIcon] = useState(routine.icon);
  ...
  return (
    <Modal title="Edit Routine" isOpen={true} onClose={onClose} size="md">
